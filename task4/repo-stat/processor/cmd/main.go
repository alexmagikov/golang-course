...
func run(ctx context.Context) error {
	...
	subscriptionInfoUseCase := usecase.NewSubscriptionInfo(collectorClient)

	processorServer := grpcController.NewProcessorServer(pingUseCase, repoUseCase, subscriptionInfoUseCase)
